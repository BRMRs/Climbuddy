...
import { Triangle, MessageCircle, TrendingUp } from 'lucide-react';
  ...
  return (
    <div className="h-[96px] bg-white border-t-[3px] border-slate-900 shrink-0 flex justify-around items-center px-4 z-30 pb-6 pt-2">
      <button 
        ...
        className="flex flex-col items-center justify-center transition-transform hover:scale-110 active:scale-95 gap-1 w-20"
      >
